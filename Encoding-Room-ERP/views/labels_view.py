...
class LabelsView(QWidget):
    ...
    def setup_ui(self):
        ...
        # Description
        description = QLabel(
            "Manage RFID labels, templates, and printing configurations. "
            "View label history, create new label designs, and configure printing settings."
        )
